...
/// Định nghĩa cấu trúc cho một theme trong ứng dụng.
...
/// Danh sách tất cả các theme có sẵn trong ứng dụng.
class AppThemes {
  static const List<AppThemeDefinition> themes = [
    ...
    // 2. Theme Dim (giao diện sáng cũ)
    AppThemeDefinition(
      id: 'dim_blue',
      name: 'Dim Blue',
      gradientColors: [Color(0xFF2C2C54), Color(0xFF2C2C54)], // No gradient
      primaryColor: Color(0xFFE91E63),
  ...
  static AppThemeDefinition findById(String id) {
    return themes.firstWhere((theme) => theme.id == id,
        orElse: () => themes.first); // Trả về theme đầu tiên nếu không tìm thấy
  }
}